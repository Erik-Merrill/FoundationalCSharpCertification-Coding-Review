    ...
    switch (menuSelection)
    {
        ...
        case "3":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    ...
                    {
                        Console.WriteLine($"Please update the age for {ourAnimals[i, 0]}.");

                        do
                        {
                            readResult = Console.ReadLine();

                            if (int.TryParse(readResult, out animalUpdatedAge))
                            {
                                if (animalUpdatedAge > 0)
                                {
                                    ourAnimals[i, 2] = readResult;
                                }
                                else
                                {
                                    Console.WriteLine("Please enter a valid numerical age for this pet.");
                                }
                            }
                            else
                            {
                                Console.WriteLine("Please enter a valid positive integer age for this pet.");
                            }
                        } while (ourAnimals[i, 2] == "Age: ?");
                    }

                    if (ourAnimals[i, 4] == null || ourAnimals[i, 4] == "Physical description: ")
                    {
                        Console.WriteLine($"Please update the physical description for {ourAnimals[i, 0]}");
                        ...
                        } while (ourAnimals[i, 4] == null || ourAnimals[i, 4] == "Physical description: ");
                    }
                }
            }
            Console.WriteLine("Age and physical description fields have been updated.");
            Console.WriteLine("Press the Enter key to continue.");
            readResult = Console.ReadLine();
            break;
        ...
        case "4":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    if (ourAnimals[i, 3] == "Nickname: " || ourAnimals[i, 3] == null)
                    {
                        ...
                        } while (ourAnimals[i, 3] == "Nickname: " || ourAnimals[i, 3] == null);
                    }

                    if (ourAnimals[i, 5] == "Personality: " || ourAnimals[i, 5] == null)
                    {

                        do
                        {
                            Console.WriteLine($"Please enter a personality description for {ourAnimals[i, 0]}.");
                            readResult = Console.ReadLine();
                            if (readResult != null)
                            {
                                ourAnimals[i, 5] = "Personality: " + readResult.Trim();
                            }
                        } while (ourAnimals[i, 5] == "Personality: " || ourAnimals[i, 5] == null);
                    }
                }

            }
            Console.WriteLine("All nicknames and personality descriptions are up to date.");
            Console.WriteLine("Press the Enter key to continue.");
            readResult = Console.ReadLine();
            break;
